...
Describe 'ToolKit Unit Tests' {
    ...
    Context 'ToolKit - helpers de consola' {
    ...
    Context 'ToolKit - ConvertTo-AtlasHtmlEncoded' {
    ...
    Context 'ToolKit - ConvertTo-AtlasHtmlDocument' {
    ...
    Context 'ToolKit - rutas de reporte' {
        BeforeAll {
